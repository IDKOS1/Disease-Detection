...
class DiseaseTreatment {
  ...
  const DiseaseTreatment(this.preventive, this.treatment, this.vaccine);
}

class Vaccine {
  late final String company;
  late final String product;
  late final String targetPathogen;

  Vaccine(this.company, this.product, this.targetPathogen);
}
